        ...
        if (p1)
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position1.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position2.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position3.GetComponent<Transform>().position , 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position4.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position5.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position6.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position7.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position8.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position9.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    position10.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
            ...
            {
                gameObject.transform.position = Vector3.MoveTowards(gameObject.transform.position,
                    endPoint.GetComponent<Transform>().position, 15.0f * Time.deltaTime);
